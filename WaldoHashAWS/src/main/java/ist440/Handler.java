...
public class Handler implements RequestHandler<S3Event, String> {
    ...
    String bucketTwo = "ist440-waldohash-output";
    String keyTwo = "waldohash-decryption-output.txt";
    ...
    public String handleRequest(S3Event s3event, Context context) throws AmazonServiceException {
        ...
        try {
            ...
            String decryptedMsg = waldoHashBruteForce(encryptedMsg);
    ...
    public String waldoHashBruteForce(String secretMessage) {
